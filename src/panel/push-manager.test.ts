...
function vaultReturning(content: string): VaultOps {
  return { exists: async () => true, createFolder: async () => {}, createStub: async () => {}, writeText: async () => {}, writeBinary: async () => {}, readText: async () => content, readBinary: async () => new ArrayBuffer(0), remove: async () => {}, isEmptyFolder: () => false };
}
function driveSpy() {
